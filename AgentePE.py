...
os.environ["OPENAI_API_KEY"] = "llave" # Pega tu llave sk-... aquí
llm = ChatOpenAI(model="gpt-4o-mini")

# 2. Creamos la herramienta como una "Clase". ¡A prueba de fallos!
...
# Inicializamos nuestra nueva herramienta indestructible
